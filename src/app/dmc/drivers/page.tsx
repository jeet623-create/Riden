...
const drivers = [
  ...
  {id:4,name:"Wanchai Bootlert",vehicle:"Mercedes Sprinter",plate:"นค-3456",base:"Bangkok",trips:112,rating:5.0,available:true,operator:"Bangkok Fleet Co"},
  {id:5,name:"Sutin Nakprom",vehicle:"Toyota Fortuner",plate:"ขก-7890",base:"Chiang Mai",trips:28,rating:4.6,available:true,operator:"Northern Roads"},
  {id:6,name:"Krit Jansorn",vehicle:"Isuzu Minibus",plate:"สก-2345",base:"Hua Hin",trips:45,rating:4.8,available:false,operator:"Hua Hin Wheels"},
]
          ...
          <div key={d.id} style={{background:"var(--bg-surface,#111)",border:"1px solid var(--border,#242)",borderRadius:12,padding:20,transition:"border-color 150ms"}}
            ...
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:14}}>
              <div style={{display:"flex",gap:12,alignItems:"center"}}>
                <div style={{width:40,height:40,borderRadius:"50%",background:"rgba(29,158,117,0.1)",border:"1px solid rgba(29,158,117,0.2)",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"monospace",fontSize:13,fontWeight:600,color:"#1D9E75"}}>
            ...
            <div style={{fontSize:12,color:"var(--text-2,#999)",marginBottom:6}}>{d.vehicle} · <span style={{fontFamily:"monospace"}}>{d.plate}</span></div>
