...
const TT = {contentStyle:{background:"#111",border:"1px solid #242",borderRadius:8},labelStyle:{color:"#999",fontSize:11},itemStyle:{color:"#1D9E75"}}
    ...
    <motion.div initial={{opacity:0,y:8}} animate={{opacity:1,y:0}} transition={{duration:0.2}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:16,marginBottom:24}}>
        {[
          ...
          {label:"Avg Days/Trip",value:"4.2",color:"#3b82f6"},
      ...
      <div style={{background:"var(--bg-surface,#111)",border:"1px solid var(--border,#242)",borderRadius:12,overflow:"hidden"}}>
        <div style={{padding:"16px 24px",borderBottom:"1px solid var(--border,#242)",fontWeight:600,fontSize:14,color:"var(--text-1,#f0f0f0)"}}>Operator Performance</div>
        <table style={{width:"100%",borderCollapse:"collapse"}}>
          <thead><tr style={{background:"var(--bg-base,#080808)"}}>
            {["OPERATOR","TRIPS","ON-TIME","PERFORMANCE"].map(h=>(
