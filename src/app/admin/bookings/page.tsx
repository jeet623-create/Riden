    ...
    <AdminShell>
      <motion.div initial={{ opacity:0, y:8 }} animate={{ opacity:1, y:0 }} transition={{ duration:0.2 }}>
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 style={{ fontSize:22, fontWeight:700, fontFamily:'var(--font-body)' }}>Bookings</h1>
            <p style={{ fontSize:13, color:'var(--text-2)', marginTop:2 }}>{bookings.length} total bookings</p>
          </div>
          ...
          <div style={{ overflowX:'auto' }}>
            <table style={{ width:'100%', borderCollapse:'collapse' }}>
              ...
              <tbody>
                ...
                {filtered.length === 0 && (
                  <tr><td colSpan={7} style={{ padding:'48px 16px', textAlign:'center', color:'var(--text-3)' }}>No bookings found</td></tr>
                )}
              </tbody>
            </table>
          </div>
